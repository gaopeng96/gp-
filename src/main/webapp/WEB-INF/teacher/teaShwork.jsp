    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#addHwork").click(function () {
                location.href="/user/showInsertShwork";
            })
        })
                ...
                <div class="layui-card-body">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <th style="width:100px">作业名称</th>
                            <th style="width:100px">班级编号</th>
                            <th>作业题目</th>
                            <th style="width:100px">作业答案</th>
                            <th>发布时间</th>
                            <th>截止时间</th>
                            <th>管理</th>
                        </tr>
                        ...
                        <c:forEach items="${shworkList}" var="item">
                            <tr>
                                ...
                                <td>${item.endTime}</td>
                                <td>
                                    <a class="layui-btn layui-btn-sm layui-btn-normal" title="编辑" onclick="execute_open()"><i class="layui-icon layui-icon-edit"></i>查看</a>
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${pageInfo.hasPreviousPage}">
                                <li><a href="/user/selectTeaShwork?pageNum=1">首页</a></li>
                                <li><a href="/user/selectTeaShwork?pageNum=${pageInfo.prePage}">上一页</a></li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:forEach var = "index" begin="1" end="${pageInfo.pages}">
                            <li class="active"
                                ...
                                <a href="javascript:/user/selectTeaShwork?pageNum=${index}">${index}</a>
                            </li>
                        </c:forEach>
                        <c:choose>
                            <c:when test="${pageInfo.hasNextPage}">
                                <li><a href="/user/selectTeaShwork?pageNum=${pageInfo.nextPage}">下一页</a></li>
                                <li><a href="/user/selectTeaShwork?pageNum=${pageInfo.pages}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
