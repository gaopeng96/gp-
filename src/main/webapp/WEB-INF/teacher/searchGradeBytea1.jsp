                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${pageInfo.hasPreviousPage}">
                                <li><a href="/user/selectGradeByTea?pageNum=1">首页</a></li>
                                <li><a href="/user/selectGradeByTea?pageNum=${pageInfo.prePage}">上一页</a></li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:forEach var = "index" begin="1" end="${pageInfo.pages}">
                            <li class="active"
                                ...
                                <a href="javascript:/user/selectGradeByTea?pageNum=${index}">${index}</a>
                            </li>
                        </c:forEach>
                        <c:choose>
                            <c:when test="${pageInfo.hasNextPage}">
                                <li><a href="/user/selectGradeByTea?pageNum=${pageInfo.nextPage}">下一页</a></li>
                                <li><a href="/user/selectGradeByTea?pageNum=${pageInfo.pages}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
