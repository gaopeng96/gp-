...
<div class="layui-fluid">
    ...
    <div class="layui-col-md12">
        <div class="layui-card">
            <c:if test="${showGradeList.size()!=0}">
                    ...
                    <table class="layui-table layui-form" id="aa">
                        ...
                        <c:forEach items="${showGradeList}" var="item">
                            ...
                            <tr>
                                ...
                                <td>${item.grade}</td>
                                <td>
                                    <a class="layui-btn layui-btn-sm layui-btn-normal" title="重新打分" onclick="execute_open('查看成绩', 'admin_operation.html?id=1', 1000, 700)" href="javascript:;"><i class="layui-icon layui-icon-edit"></i>重新打分</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
                    ...
                    <ul class="pagination">
                        <c:choose>
                            <c:when test="${pageInfo.hasPreviousPage}">
                                <li><a href="/user/showGrade?pageNum=1">首页</a></li>
                                <li><a href="/user/showGrade?pageNum=${pageInfo.prePage}">上一页</a></li>
                            </c:when>
                            <c:otherwise>
                        ...
                        <c:forEach var = "index" begin="1" end="${pageInfo.pages}">
                            <li class="active"
                                ...
                                <a href="javascript:/user/showGrade?pageNum=${index}">${index}</a>
                            </li>
                        </c:forEach>
                        <c:choose>
                            <c:when test="${pageInfo.hasNextPage}">
                                <li><a href="/user/showGrade?pageNum=${pageInfo.nextPage}">下一页</a></li>
                                <li><a href="/user/showGrade?pageNum=${pageInfo.pages}">尾页</a></li>
                            </c:when>
                            <c:otherwise>
