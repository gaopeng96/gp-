...
<div>
    <div class="container">
        <form class="form-horizontal" role="form"  onsubmit="return checkForm();"  action="/user/updateTeaPwd" method="post">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control"  id="rtpwd" placeholder="输入旧密码" onblur="pwd()">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" name="tpwd1" id="tpwd1" placeholder="输入新密码" onblur="checkPwdLength()">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" name="tpwd" id="tpwd" placeholder="确认密码"  onblur="confirmPwd()">
