...
<div>
    <div class="container">
        <form class="form-horizontal" role="form"  onsubmit="return checkForm();"  action="/user/insertTeacher" method="post">

            <div class="form-group">
                <label class="col-sm-2 control-label">老师编号：</label>
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="tno" id="tno"  placeholder="请输入编号" onblur="isExists()">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="password" class="form-control" name="tpwd" id="tpwd"  value="123456">
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="tname" id="tname" placeholder="请输入姓名"  onblur="checkName()">
                </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" name="tage"  id="tage" placeholder="请输入年龄"  onblur="checkAge()">
